...
export const formatReflectionSummary = (student: any, questions: string[]) =>
  getReflectionAnswers(student, questions)
    .map(({question, answer}, index) => `${index + 1}. ${question}: ${answer || 'No answer yet'}`)
    .join(' | ');
...
export const itemsbuy = [
  ...
  {
    id: 'single_packed_bread',
    name: 'Single Packed Bread',
    price: 2,
    unit: 'per packet',
  ...
  {
    id: 'percussion_triangle_a',
    name: 'Percussion Triangle A',
    price: 12,
    unit: 'per set',
  ...
  {
    id: 'bus_transport_2_way',
    name: '2 Way Bus Transport',
    price: 130,
    unit: '',
    category: 'Activities & Events',
  },
